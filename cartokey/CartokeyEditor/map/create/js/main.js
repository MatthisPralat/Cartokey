...
+" <div id='title-Legend'>Mon titre</div>"
+"</div>";

//--------- CONTENT
legendC = " " ; 
Legendphp = ""+"&lt;h1 style=\"text-align: center;\"&gt;test&lt;\/h1&gt;"+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(176,210,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;Chomage01 &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(255,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;Test2 &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(255,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;azea &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;azea &lt;/div&gt;'+"&lt;h1 style=\"text-align: center;\"&gt;retest&lt;\/h1&gt;\n&lt;p style=\"text-align: center;\"&gt;coucou&lt;\/p&gt;"+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(255,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(255,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(28,106,11,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aaze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;'+'&lt;div style=\' margin: 5px auto; text-align:center;\'&gt; &lt;i style=\'background:rgba(0,0,0,1) ;width:15px;height:15px;display:block; float:left; margin-left:15px;\'&gt;&lt;/i&gt;aze &lt;/div&gt;';
...
var layer0 = {
					"title" :
					{ 
						"dynamic":"['feature']['properties']['none']"
					},
					"name":"layer0",
					...
					"Options":
					{
					 ...
					 "onEach": { "popup": "yes",  "popupEl": [ ]}, "style": { "selector": "none", "case": {"Allemagne":"undefined","Autriche":"ff0000","Belgique":"undefined","Bulgarie":"ff0000","Chypre":"undefined","Croatie":"undefined","Danemark":"undefined","Espagne":"undefined","Estonie":"undefined","Finlande":"undefined","France":"undefined","Grèce":"undefined","Hongrie":"undefined","Irlande":"undefined","Irlande du Nord":"undefined","Italie":"undefined","Lettonie":"006dff","Lituanie":"undefined","Luxembourg":"ff0000","Malte":"undefined","Pays-Bas":"undefined","Pologne":"undefined","Portugal":"undefined","Roumanie":"undefined","Royaume-uni":"undefined","République tchèque":"undefined","Slovaquie":"undefined","Slovénie":"undefined","Suède":"undefined"}}} ;var SelC = '<a onClick="initLayer( [BaseCompil],[layer0])"> Bouton0</a>'; 
//------------------------------------------------SELECTOR----------------------------------------------------------------
