...
var layer1 = {
					...
					"Options":
					{
					 ...
					 "onEach": { "popup": "yes",  "popupEl": [ {
							"title": "admin_fr",
							"el": " feature.properties.admin_fr"},{
							"title": "admin",
							"el": " feature.properties.admin"},{
							"title": "Tauxcolor",
							"el": " feature.properties.Tauxcolor"},{
							"title": "Taux",
							"el": " feature.properties.Taux"}]}, "style": { "selector": "Tauxcolor", "case": {"1":"4379ff","2":"d37900","3":"e80303","4":"660101","5":"ffffff","":"ffffff"}}} ;var layer0 = {
					"title" :
					{ 
					...
					"Options":
					{
					 ...
					 "onEach": { "popup": "yes",  "popupEl": [ ]}, "style": { "selector": "none", "case": {}}} ;var SelC = '<a onClick="initLayer( [BaseCompil],[layer1])"> Taux de chômage</a>'; 
//------------------------------------------------SELECTOR----------------------------------------------------------------
