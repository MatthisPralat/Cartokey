...
var layer1 = {
					...
					"Options":
					{
					 ...
					 "onEach": { "popup": "yes",  "popupEl": [ {
							...
							"title": "Taux",
							"el": " feature.properties.Taux"}]}, "style": { "selector": "Tauxcolor", "case": {"1":"ffce43","2":"d37900","3":"e80303","4":"790a0a","5":"ffffff","":"ffffff"}}} ;var SelC = '<a onClick="initLayer( [BaseCompil],[layer1])"> Taux de chômage</a><a onClick="initLayer( [BaseCompil],[layer1])"> Bouton1</a>'; 
//------------------------------------------------SELECTOR----------------------------------------------------------------
